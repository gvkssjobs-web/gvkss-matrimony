        ...
        <div className="w-full mx-auto pt-8 px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-2">
              <span className="bg-gradient-to-r bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(to right, #CA8A04, #16A34A, #CA8A04)' }}>Gold</span>{' '}
              <span style={{ color: '#111827' }}>Dashboard</span>
            </h1>
            <p className="text-lg" style={{ color: '#374151' }}>Browse all Silver and Gold members</p>
          </div>
          
          <RoleFilterBar
            availableRoles={['silver', 'gold']}
