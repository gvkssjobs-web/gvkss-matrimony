    ...
    <nav className="fixed w-full z-50 bg-pink-600 transition-all duration-200" style={{ top: '30px' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Notifications */}
          {user && (
            <button className="p-2.5 rounded-lg hover:bg-white/20 transition relative">
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
              </svg>
              <span className="absolute -top-1 -right-1 w-5 h-5 bg-white text-pink-600 text-xs font-bold rounded-full flex items-center justify-center border-2 border-pink-600">2</span>
            </button>
          )}
