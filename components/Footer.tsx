        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex gap-4">
                <a href="#" className="text-zinc-600 transition-colors" style={{ color: '#374151' }} onMouseEnter={(e) => e.currentTarget.style.color = '#16A34A'} onMouseLeave={(e) => e.currentTarget.style.color = '#374151'}>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold mb-4" style={{ color: '#111827' }}>Quick Links</h4>
        ...
        <div className="mt-8 pt-8 border-t border-zinc-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs" style={{ color: '#9CA3AF' }}>
              © {new Date().getFullYear()} GVKSS Software Pvt. Ltd. All rights reserved.
            </p>
            <div className="flex gap-6">
              <a href="#" className="text-xs transition-colors" style={{ color: '#9CA3AF' }} onMouseEnter={(e) => e.currentTarget.style.color = '#16A34A'} onMouseLeave={(e) => e.currentTarget.style.color = '#9CA3AF'}>
                Privacy
              </a>
              <a href="#" className="text-xs transition-colors" style={{ color: '#9CA3AF' }} onMouseEnter={(e) => e.currentTarget.style.color = '#16A34A'} onMouseLeave={(e) => e.currentTarget.style.color = '#9CA3AF'}>
                Terms
